...
function App(){
 ...
 return <main className={`companion ${state}`}>
  ...
  <section className="stage"><div className="stage-glow"/><div className="character"><div className="character-hair"/><div className="character-face"><i className="eye left"/><i className="eye right"/><b className="smile"/><span className="blush left"/><span className="blush right"/></div><div className="character-neck"/><div className="character-body"><div className="collar"/> <span className="shirt-mark">✦</span></div></div><div className="character-shadow"/><div className="stage-caption"><div className="caption-kicker">ЛИЯ</div><h1>{labels[state]}</h1><p>{state==='listening'?'Говори свободно — я пойму тебя':state==='thinking'?'Собираю мысли в слова':'Я всегда готова выслушать'}</p></div></section>
