// Мост ARKit-52 → морфы этой модели. Audio2Face-3D выдаёт ARKit-подобные blendshapes
// (52 веса на кадр, 30 кадров/с), а Lia_v2.vrm — VRoid-модель с 57 морфами Fcl_*:
// каждый ARKit-шейп приходится либо на один Fcl_-морф (с гейном), либо честно
